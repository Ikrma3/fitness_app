...
class HomeCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool hasimaegs = cardData['details'] != null &&
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (hasimaegs)
            buildWithimaeg(context)
          else
            buildWithoutimaeg(context),
        ],
      ),
    );
  }

  Widget buildWithimaeg(BuildContext context) {
    Brightness brightness = Theme.of(context).brightness;
    Color tColor = brightness == Brightness.dark ? Colors.white : Colors.black;
  ...
  Widget buildWithoutimaeg(BuildContext context) {
    Brightness brightness = Theme.of(context).brightness;
    Color tColor = brightness == Brightness.dark ? Colors.white : Colors.black;
    List<Color> colors = [
