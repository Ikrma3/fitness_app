            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "You’ll see your daily diary here - and better understand how your feed choices impact sleep level.",
                    style: TextStyle(
                        fontSize: 16.sp,
                        fontFamily: 'Inter',
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SleepScreenFood()),
                        );
                      },
                      child: Text(
                        'Add Food',
                        style: TextStyle(
                            color:
                                Color.fromRGBO(21, 109, 149, 1), // Text color
                            fontSize: 16.sp,
